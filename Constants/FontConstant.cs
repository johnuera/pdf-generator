...
namespace PDFGenerator.Constants
{
    public static class FontConstant
    {
        ...
        public static readonly XFont DefaultFontHeader = new XFont("Arial", 20, XFontStyleEx.Regular);

        public static readonly XFont DefaultFontBold = new XFont("Arial", 9, XFontStyleEx.Bold);

        public static readonly XFont TableHeaderFont = new XFont("Arial", 6, XFontStyleEx.Bold);
